...
9. 8-sum_listint.c - Write a function that returns the sum of all the data (n) of a listint_t linked list.

Prototype: int sum_listint(listint_t *head);
if the list is empty, return 0.

10. 9-insert_nodeint.c - Write a function that inserts a new node at a given position.
...
12. 100-reverse_listint.c - Write a function that reverses a listint_t linked list.
...
13. 101-print_listint_safe.c - Write a function that prints a listint_t linked list.
...
14. 102-free_listint_safe.c - Write a function that frees a listint_t list.
...
15. 103-find_loop.c - Write a function that frees a listint_t list.
